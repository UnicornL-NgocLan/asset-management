...
const TemporaryList = ({
  ...
  inventoryLines: IAssetInventoryAssetTemporary[];
}) => {
  ...
  const getColumnSearchProps = (
    dataIndex: DataIndex
  ): TableColumnType<IAssetInventoryAssetTemporary> => ({
  ...
  return (
    <>
      {['draft', 'process'].some((i) => i === auditData?.state) && (
        <div style={{ padding: '0 1rem 0rem', marginBottom: inventoryLines.length === 0 ? 16 : 0 }}>
          <Button
            size="large"
