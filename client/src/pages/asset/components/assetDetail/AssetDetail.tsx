...
const AssetDetail = () => {
  ...
  return (
    ...
    >
          ...
          <div onClick={() => setActive(4)}>
            <span
              style={{
                ...
                fontSize: 12,
                color: `${active === 4 ? myColor.buttonColor : 'grey'}`,
              }}
            >
              Điều chỉnh
            </span>
          ...
          <div onClick={() => setActive(5)}>
            <span
              style={{
                ...
                fontSize: 12,
                color: `${active === 5 ? myColor.buttonColor : 'grey'}`,
              }}
            >
              Sửa chữa
            </span>
      ...
      <div
        style={{ padding: '0.5rem 1rem', background: myColor.backgroundColor, overflow: 'auto' }}
      >
        {handleViewContent()}
      </div>
    </div>
