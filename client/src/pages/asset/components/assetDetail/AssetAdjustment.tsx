              ...
              >
                <div>
                  <h4 style={{ margin: 0, fontWeight: 500, fontSize: 13 }}>
                    {item.date_adjustment &&
                      moment(item.date_adjustment).add(7, 'hours').format('DD-MM-YYYY')}{' '}
                  ...
                  <div>
                    ...
                    >
                      <span style={{ fontWeight: 500 }}>Số lượng điều chỉnh: </span>
                      <img
                        src={item.increase_quantity >= 0 ? increase : decrease}
                        alt=""
                        style={{ height: 15 }}
                      />{' '}
                      {item.increase_quantity < 0
                        ? item.increase_quantity * -1
                        : item.increase_quantity}
                    </p>
                    <p style={{ fontSize: 12, margin: '0.5rem 0' }}>
                      <span style={{ fontWeight: 500 }}>Mô tả: </span> {item.description}
                    </p>
                    <p style={{ fontSize: 12, margin: '0.5rem 0' }}>
                      <span style={{ fontWeight: 500 }}>Tài liệu tham chiếu: </span>{' '}
                      {item.document_ref}
                    </p>
                    <p style={{ fontSize: 12, margin: '0.5rem 0' }}>
                      <span style={{ fontWeight: 500 }}>Nhà cung cấp:</span> {item.vendor_name}
                    </p>
                  </div>
                </div>
              </div>
