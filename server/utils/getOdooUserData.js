export async function getUserData(odoo, uid) {
  return new Promise((resolve, reject) => {
    const params = [[["id", "=", uid]], ["id", "name", "company_ids", "company_id", "email", "in_group_132", "in_group_131"]];
...
export async function getAssetAdjustmentLines(odoo, id) {
  return new Promise((resolve, reject) => {
    const inParams = [];
    inParams.push([["asset_id", "=", parseInt(id)]]);
    inParams.push(["id", "adjustment_code", "increase_quantity", "date_adjustment", "description", "document_ref", "vendor_name"]);
    inParams.push(0);
    const params = [];
    params.push(inParams);
...
export async function getAssetRepair(odoo, id) {
  return new Promise((resolve, reject) => {
    const inParams = [];
    inParams.push([["asset_id", "=", parseInt(id)]]);
    inParams.push(["id", "repair_date_start", "repair_date_end", "repair_party", "accident_place", "description", "quantity"]);
    inParams.push(0);
    const params = [];
    params.push(inParams);
...
export async function getAssetTypes(odoo) {
  return new Promise((resolve, reject) => {
    const inParams = [];
    inParams.push([]);
    inParams.push(["id", "name"]);
    ...
    const params = [];
    params.push(inParams);
    odoo.execute_kw("account.asset.type", "search_read", params, (err, offices) => {
      if (err) {
        reject(err);
      } else {
        resolve(offices);
...
export async function getAssetInventoryCommitee(odoo, auditId) {
  return new Promise((resolve, reject) => {
    ...
    inParams.push(["id", "employee_id_temp", "position", "confirm_completed", "assigned_verify"]);
    inParams.push(0);
    const params = [];
    params.push(inParams);
...
export async function getAssetInventoriedDept(odoo, auditId) {
  return new Promise((resolve, reject) => {
    const inParams = [];
    inParams.push([["asset_inventory_id", "=", parseInt(auditId)]]);
    inParams.push(["id", "employee_id_temp", "department", "confirm_completed", "assigned_verify"]);
    inParams.push(0);
    const params = [];
    params.push(inParams);
...
export async function getHrEmployeeTemporary(odoo, list) {
  return new Promise((resolve, reject) => {
    const inParams = [];
    inParams.push([["id", "in", list]]);
    inParams.push(["employee_id"]);
    inParams.push(0);
    const params = [];
    params.push(inParams);
    odoo.execute_kw("hr.employee.temporary", "search_read", params, (err, data) => {
      if (err) {
        reject(err);
      } else {
        resolve(data);
...
export async function getEmployeeMultiCompany(odoo, list) {
  return new Promise((resolve, reject) => {
    const inParams = [];
    inParams.push([["id", "in", list]]);
    inParams.push(["name"]);
    ...
    const params = [];
    params.push(inParams);
    odoo.execute_kw("hr.employee.multi.company", "search_read", params, (err, data) => {
      if (err) {
        reject(err);
      } else {
        resolve(data);
...
export async function getUserIdsOfHrEmployee(odoo, list) {
  return new Promise((resolve, reject) => {
    const inParams = [];
    inParams.push([["id", "in", list]]);
    inParams.push(["user_id"]);
    inParams.push(0);
    const params = [];
    params.push(inParams);
...
export async function setUserConfirmAssetInventory(odoo, uid) {
  return new Promise((resolve, reject) => {
    let params = [];
    params.push([parseInt(uid)]);
    odoo.execute_kw("asset.inventory", "set_state_confirmed", params, function (err, user) {
      if (err) {
        reject(err);
      } else {
        resolve(user);
...
export async function setUserUnConfirmAssetInventory(odoo, uid) {
  return new Promise((resolve, reject) => {
    let params = [];
    params.push([parseInt(uid)]);
    odoo.execute_kw("asset.inventory", "set_state_unconfirmed", params, function (err, user) {
      if (err) {
        reject(err);
      } else {
        resolve(user);
...
export async function changeAssetInventoryFromProcessToVerifyState(odoo, uid) {
  return new Promise((resolve, reject) => {
    let params = [];
    params.push([parseInt(uid)]);
    odoo.execute_kw("asset.inventory", "set_state_verifying", params, function (err, user) {
      if (err) {
        reject(err);
      } else {
        resolve(user);
...
export async function changeAssetInventoryFromVerifyingToProcessState(odoo, uid) {
  return new Promise((resolve, reject) => {
    let params = [];
    params.push([parseInt(uid)]);
    odoo.execute_kw("asset.inventory", "set_state_process", params, function (err, user) {
      if (err) {
        reject(err);
      } else {
        resolve(user);
